...
<InteractiveDiagram title="Standard Operational Amplifier Configuration" type="opamp" />
...
<InteractiveTable 
  title="Passive Component Specifications" 
  specs={[
    { label: "Resistor (R)", value: "Resistance (Ω)", detail: "Limits electrical current flow according to Ohm's Law (V=IR)." },
    { label: "Capacitor (C)", value: "Capacitance (F)", detail: "Stores electrical energy in an electric field. Common in filters." },
    { label: "Inductor (L)", value: "Inductance (H)", detail: "Stores energy in a magnetic field. Used in power conversion." }
  ]} 
/>
...
<InteractiveDiagram title="Bipolar Junction Transistor (NPN)" type="transistor" />
...
<InteractiveDiagram title="Standard 2-Input AND Gate" type="logic" />
